...
func printHelp() {
	fmt.Println("TierFlow " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Based on: New API by QuantumNous - https://github.com/QuantumNous/new-api")
	fmt.Println("Original Project: OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Usage: tierflow [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
...
func InitEnv() {
	...
	ApplianceMode = GetEnvOrDefaultBool("APPLIANCE_MODE", false)
