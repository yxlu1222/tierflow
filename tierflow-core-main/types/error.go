...
const (
	ErrorTypeNewAPIError     ErrorType = "tierflow_error"
...
const (
	...
	// subscription quota error — 与钱包额度不足区分,便于上层精确回退/提示
	ErrorCodeNoActiveSubscription          ErrorCode = "no_active_subscription"
