...
// ChannelSummary is one channel's aggregated performance for a model over the
// query window, for the model detail view.
...
// ChannelSummaryResult is the per-channel performance breakdown for one model.
