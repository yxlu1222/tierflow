...
import (
	...
	"github.com/Zer0Echo/tierflow-core/relay/channel/ai360"
	"github.com/Zer0Echo/tierflow-core/relay/channel/lingyiwanwu"

	//"github.com/Zer0Echo/tierflow-core/relay/channel/minimax"
	"github.com/Zer0Echo/tierflow-core/relay/channel/openrouter"
	"github.com/Zer0Echo/tierflow-core/relay/channel/xinference"
	relaycommon "github.com/Zer0Echo/tierflow-core/relay/common"
	"github.com/Zer0Echo/tierflow-core/relay/common_handler"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		if header.Get("HTTP-Referer") == "" {
			header.Set("HTTP-Referer", "https://github.com/Zer0Echo/tierflow-core")
		}
		if header.Get("X-OpenRouter-Title") == "" {
			header.Set("X-OpenRouter-Title", "TierFlow")
		}
	}
	return nil
}
...
func (a *Adaptor) ConvertOpenAIRequest(c *gin.Context, info *relaycommon.RelayInfo, request *dto.GeneralOpenAIRequest) (any, error) {
	...
	// 注：DeepSeek 思考模式的 reasoning 连续性处理不在这里 —— 它按渠道类型内建在
	// relay/channel/deepseek 的 ConvertOpenAIRequest 里。把 DeepSeek 配成 openai 类型渠道
	// (例如指向聚合商)则不覆盖，需要把渠道类型改成 DeepSeek。
