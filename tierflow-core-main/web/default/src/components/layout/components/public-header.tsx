...
export function PublicHeader(props: PublicHeaderProps) {
  ...
  useEffect(() => {
    // Header 固定不收回;底部描边常驻,仅在滚动离顶时切换背景/模糊样式。
    const onScroll = () => {
    ...
    <>
      ...
      >
        <div className='pointer-events-auto mx-auto max-w-7xl px-4 md:px-6'>
          <nav className='flex h-20 items-center px-2'>
            ...
            <div className='flex items-center'>
              ...
              {/* Desktop primary nav — 紧邻品牌名,左对齐 */}
              <div className='ml-6 hidden items-center gap-0.5 sm:flex lg:ml-10'>
                {links.map((link, i) => {
                  ...
                  if (link.external) {
                    return (
                      <a
                        ...
                        className={cn(
                          'text-muted-foreground hover:text-foreground rounded-lg px-4 py-2 text-[15px] font-medium transition-colors duration-200',
                  ...
                  return (
                    <Link
                      ...
                      onClick={(event) => handleNavLinkClick(event, link)}
                      className={cn(
                        'rounded-lg px-4 py-2 text-[15px] font-medium transition-colors duration-200',
                        isActive
                          ? 'text-foreground'
            ...
            <div className='hidden items-center gap-1 sm:flex'>
              ...
              {showNotifications &&
                (isAuthenticated ? (
                  ...
                  <NotificationBell
                    to='/sign-in'
                    search={{ redirect: '/notifications/system' }}
                    unreadCount={notifications.unreadCount}
                  />
                ))}
