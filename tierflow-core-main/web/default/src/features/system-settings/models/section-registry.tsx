...
import { ModelVisibilitySection } from './model-visibility-section'
import { InferenceSettingsSection } from '../integrations/inference-settings-section'
...
const MODELS_SECTIONS = [
  ...
  {
    id: 'model-visibility',
    titleKey: 'Model Visibility',
    build: (settings: ModelSettings) => (
      <ModelVisibilitySection
        defaultValues={{
          exposeUpstream: settings['ExposeUpstreamModels'],
          restrictDirect: settings['RestrictDirectModelCall'],
        }}
      />
    ),
  },
  {
    id: 'inference',
    titleKey: 'Inference Service',
    build: (settings: ModelSettings) => (
      <InferenceSettingsSection
        defaultValues={{
          url: settings['inference.url'],
          secret: settings['inference.secret'],
          timeoutMs: settings['inference.timeout_ms'],
        }}
      />
    ),
  },
