...
const quotaSchema = z.object({
  ...
  quota_setting: z.object({
    ...
    enable_invitation_reward: z.boolean(),
  }),
})
        ...
        <SettingsForm onSubmit={handleSubmit}>
          ...
          <SettingsFormGrid>
            ...
            <SettingsFormGridItem span='full'>
              <FormField
                control={form.control}
                name='quota_setting.enable_invitation_reward'
                render={({ field }) => (
                  <SettingsSwitchItem>
                    <SettingsSwitchContent>
                      <FormLabel>{t('Invitation Reward Program')}</FormLabel>
                      <FormDescription>
                        {t(
                          'When disabled, invitation rewards stop accruing for new sign-ups, the referral card is hidden in the wallet, and users cannot transfer referral rewards to their balance.'
                        )}
                      </FormDescription>
                    </SettingsSwitchContent>
                    <FormControl>
