...
export function ApiKeysMutateDrawer({
  ...
  // The user's own pricing group (defaults to `default`); shown as the concrete
  // group when a token has no explicit group set.
              ...
              <Collapsible open={groupOpen} onOpenChange={setGroupOpen}>
                <CollapsibleTrigger
                  render={
                    <button
                      type='button'
                      className='hover:bg-muted/40 flex w-full items-center justify-between gap-3 rounded-md px-1 py-1.5 text-left transition-colors'
                    />
                  }
                >
                  <span className='flex flex-col gap-0.5'>
                    ...
                    <span className='text-muted-foreground text-xs'>
                      {t('Click to choose another group')}
                    </span>
                  </span>
                  <span className='flex items-center gap-1.5'>
                    <span className='text-muted-foreground [font-family:var(--font-body)] text-xs'>
