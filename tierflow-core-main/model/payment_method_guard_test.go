...
func TestExpireSubscriptionOrder_RejectsMismatchedPaymentProvider(t *testing.T) {
	...
	insertSubscriptionOrderForPaymentGuardTest(t, "sub-expire-guard", 303, plan.Id, PaymentProviderBalance)

	err := ExpireSubscriptionOrder("sub-expire-guard", PaymentProviderEpay)
	require.ErrorIs(t, err, ErrPaymentMethodMismatch)
